...
<body>
	...
	<button id="gotoup"
		style="top: 526px; left: 744px; width: 150px; height: 72px; background-color: green; font-size: 25px; position: absolute;">查看上次生成表单</button>
	...
	<script type="text/javascript">
						...
						success : function(data) {
							if(data.status=="SUCCESS"){
								...
								window.setTimeout(function() {
									//window.open("http://www.34nn.top:8081/pdf/ceshi.pdf");
									window.open("http://127.0.0.1:8080/pdf/ceshi.pdf");
								},2000);
		...
		$("#gotoup").click(function () {
			//window.open("http://www.34nn.top:8081/pdf/ceshi1.pdf");
			window.open("http://127.0.0.1:8080/pdf/ceshi1.pdf");
		});
	</script>
</body>
</html>